    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "32px" }}>
          ...
          <span style={{ fontSize: 36, fontWeight: 700, letterSpacing: "-0.02em" }}>dobeu</span>
        </div>
        <div style={{ fontSize: 72, fontWeight: 800, lineHeight: 1.05, letterSpacing: "-0.025em", display: "flex", flexDirection: "column" }}>
