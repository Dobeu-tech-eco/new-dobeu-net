...
const STEPS = [
  {
    ...
    body: "Around five minutes. The questions adapt to the service you pick, so you only answer what is relevant."
  },
  {
    ...
    <main className="mx-auto w-full max-w-4xl px-4 py-12 sm:px-6 lg:py-16">
      <header className="mb-10 space-y-4">
        ...
        <p className="max-w-2xl text-muted-foreground">
          Scope your project in about five minutes and we&apos;ll send a planning estimate
