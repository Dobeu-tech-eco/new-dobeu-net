...
export function LightboxProvider({ children }: { children: React.ReactNode }) {
  ...
  // ⚡ Bolt: Memoize the context value to maintain referential equality across renders.
  // This prevents unnecessary re-renders of all components consuming useLightbox()
  // when the LightboxProvider's internal state (isOpen, tab) changes.
