...
export function LightboxProvider({ children }: { children: React.ReactNode }) {
  ...
  // ⚡ Bolt: Memoize context value to prevent unnecessary app-wide re-renders
  // of consuming components when internal LightboxProvider state changes.
  // Impact: O(1) referential equality check prevents full subtree reconciliation in consumers.
