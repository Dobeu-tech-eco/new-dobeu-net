...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "dobeu-hero":
          "radial-gradient(ellipse 80% 60% at 50% 0%, hsl(var(--primary) / 0.15), transparent 60%), radial-gradient(ellipse 60% 50% at 80% 100%, hsl(var(--accent) / 0.12), transparent 60%)",
        "dobeu-mesh":
          "radial-gradient(at 0% 0%, hsl(var(--primary) / 0.18) 0%, transparent 50%), radial-gradient(at 100% 100%, hsl(var(--accent) / 0.14) 0%, transparent 50%), radial-gradient(at 50% 50%, hsl(var(--primary) / 0.06) 0%, transparent 60%)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
