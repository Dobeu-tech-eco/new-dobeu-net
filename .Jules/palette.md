...
## 2024-06-21 - Accessible Responsive Text Hiding
**Learning:** When using responsive utility classes like `hidden sm:inline` to hide text inside interactive elements on smaller screens, it creates an icon-only button on mobile that lacks context for screen readers.
